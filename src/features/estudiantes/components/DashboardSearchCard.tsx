...
export const DashboardSearchCard = ({ item, onJobClick }: DashboardSearchCardProps) => {
  return (
    <article 
      ...
      className="cursor-pointer rounded-2xl border border-[#e6e0d7] border-b-2 border-b-[#009A4D] bg-white px-4 py-4 shadow-[0_2px_12px_rgba(23,34,55,0.06)] transition-all duration-200 hover:-translate-y-0.5 hover:border-b-[#059669] hover:shadow-[0_12px_24px_rgba(23,34,55,0.12)]">
      ...
      <div className="mt-3 flex justify-end gap-2">
        <span className="rounded-md bg-[rgba(16,185,129,0.12)] px-2.5 py-1 text-xs font-medium text-[#059669]">{item.type}</span>
